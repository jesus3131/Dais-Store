    ...
    <section id="instagram" className="py-16 lg:py-20 bg-white">
      <div className="max-w-[var(--spacing-container-max)] mx-auto px-[var(--spacing-margin-mobile)] lg:px-[var(--spacing-margin-desktop)]">
        <div className="flex items-center justify-between mb-10">
          ...
          <a href="https://instagram.com/dais_store" target="_blank" rel="noopener noreferrer"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
          {images.map((item, i) => (
            <a key={i} href="https://instagram.com/dais_store" target="_blank" rel="noopener noreferrer"
